...
# base_dir=os.path.join(path,'CURVATURE-BASED-MACHINE-LEARNING-FOR-AUTOMATED-SEGMENTATION-OF-neldRITIC-smodS')
...
file_path_org=os.getcwd()  #os.path.join(base_dir,'neld_analysis')# 
file_path_data=os.path.join(file_path_org,'files','data_initial')
