...
file_path_org=os.path.join(file_path_org,'files') 
DTYPE='float32'  
...
class get_data:
    def __init__(self, file_path_data): 
        ...
        neld_namess = [[f'{dn}_',df,f'{df}sp'] for dn,df in zip(neld_names,neld_first)]
...
class get_data_all:
    def __init__(self, neld_data=None,names_dic={},obj_org_path=None,file_path_data=None,true_keys=[f'true_0',],cpath=None, ):  
        self.neld_data=neld_data   
