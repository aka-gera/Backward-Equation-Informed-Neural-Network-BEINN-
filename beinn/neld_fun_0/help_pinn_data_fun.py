...
class pinn_data(get_name,get_param):
    def __init__(self,file_path,
        ...
        self.neld_path_original_m=neld_path_original_m
    ...
    def get_intensity_head_neck(self, 
        ...
        neld_path_original_m=neld_path_original_m or self.neld_path_original_m 
        ...
        np.savetxt(os.path.join(neld_path_true_final,'intensity_hmod_smod.txt'), intensity, fmt='%d')
        np.savetxt(os.path.join(neld_path_true_final,'intensity_1hot_hmod_smod.txt'), intensity_1hot, fmt='%d')
    ...
    def get_pinn_rhs(self,
        ...
        hmod_path_tmp=os.path.join(neld_path_true_final,f'intensity_1hot_hmod_{pre_portion}.txt')
        # if pre_portion=='head_neck': 
        #     hmod_path_tmp=os.path.join(neld_path_true_final,'intensity_1hot_hmod_neck_head.txt')
        #     if not os.path.exists(hmod_path_tmp):
        #         self.get_intensity_head_neck(radius_threshold=radius_threshold) 
        # elif pre_portion=='smod':  
        #     hmod_path_tmp=os.path.join(neld_path_true_final,'intensity_1hot_hmod_smod.txt')
        #     if not os.path.exists(hmod_path_tmp):
        #         self.get_intensity_head_neck(radius_threshold=radius_threshold)
        # elif pre_portion=='head':  
        #     hmod_path_tmp=os.path.join(neld_path_true_final,'intensity_1hot_hmod_head.txt')
        #     if not os.path.exists(hmod_path_tmp):
        #         self.get_intensity_head_neck(radius_threshold=radius_threshold)
        # elif pre_portion=='neck':  
        #     hmod_path_tmp=os.path.join(neld_path_true_final,'intensity_1hot_hmod_neck.txt')
        #     if not os.path.exists(hmod_path_tmp):
        #         self.get_intensity_head_neck(radius_threshold=radius_threshold)
