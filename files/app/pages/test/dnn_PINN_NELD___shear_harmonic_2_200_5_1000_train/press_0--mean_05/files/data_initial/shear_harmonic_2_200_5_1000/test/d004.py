...
dend_names = ['d004']
dend_namess = ['d004_', 'd004', 'd004']
dend_path_inits =['shear_harmonic_2_200_5_1000_test']
data_studied = 'test'  
model_sufix = 'press_0--mean_05' 
path_train= None
path_file= None
path_file_sub=None
path_file_dir='/Users/akag/Desktop/neld/files/app/pages/test/dnn_PINN_NELD___shear_harmonic_2_200_5_1000_train/press_0--mean_05/files/data_initial/shear_harmonic_2_200_5_1000/test/path_files.pkl'
pinn_dir_data='None'
dend_data=None
index=4
...
title_dend_name = f'd004'
dash.register_page(__name__, title=title_dend_name, name=title_dend_name, order=4) 
