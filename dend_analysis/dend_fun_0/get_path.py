...
class get_name:
    def __init__(self): 
        ...
        self.dend_file=['vertices_head','vertices_neck','vertices_smod','faces_head','faces_neck','faces_smod', "vertices_1","vertices_0",'faces_0']  
        self.inttt=[]
...
class get_files(get_name,get_param):
    def __init__(self,
        ...
        if dend_data is not None:
            ...
            self.name_smod_id =name_smod_id if name_smod_id is not None else dend_data['name_smod_id']
            ...
            self.name_hmod_id = name_hmod_id if name_hmod_id is not None else dend_data['name_hmod_id']
        ...
        # mnn=dend_data['cpath']
        self.file_path_model_data= os.path.join(file_path_org,'data',*self.dend_data['cpath'])
    ...
    def get_dend_name(self, index,
        ...
        self.last_name,self.sp_name_hmod=dend_namess[index][0],dend_namess[index][1]  
...
from dend_fun_0.get_path import get_path_train,get_name,get_model_name
